  ...
  return (
    <div style={{
      ...
      <header style={{ textAlign: 'center', marginBottom: 32 }}>
        <h1 style={{ fontSize: 32, margin: 0 }}>MindfulCheck</h1>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        <ul style={{ listStyle: 'none', padding: 0 }}>
          {features.map((feature, idx) => (
            <li key={idx} style={{ margin: '18px 0', padding: 12, background: '#fafafa', borderRadius: 6 }}>
      ...
      <section style={{ marginBottom: 40 }}>
        ...
        {testimonials.map((t, idx) => (
          <blockquote key={idx} style={{ borderLeft: '4px solid #1976d2', margin: '16px 0', paddingLeft: 12, color: '#333' }}>
            "{t.quote}"<br />
